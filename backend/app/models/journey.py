...
class TimeEstimate(BaseModel):
    ...
    start_date: Optional[datetime] = Field(
        None,
        description="The earliest estimated date/time of arrival."
    )
    end_date: Optional[datetime] = Field(
        None,
        description="The latest estimated date/time of arrival."
    )
...
class Journey(BaseModel):
    ...
    is_public: bool = Field(
        True,
        description="Whether this journey is visible to other users on the map."
    )
